...
public class ElseIfType implements java.io.Serializable {
     ...
     */
    private cto.framework.service.plugin.schema.ElseIfTypeChoice _elseIfTypeChoice;
     ...
     */
    public cto.framework.service.plugin.schema.ElseIfTypeChoice getElseIfTypeChoice() {
     ...
     */
    public void setElseIfTypeChoice(final cto.framework.service.plugin.schema.ElseIfTypeChoice elseIfTypeChoice) {
     ...
     * cto.framework.service.plugin.schema.ElseIfType
     */
    public static cto.framework.service.plugin.schema.ElseIfType unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (cto.framework.service.plugin.schema.ElseIfType) org.exolab.castor.xml.Unmarshaller.unmarshal(cto.framework.service.plugin.schema.ElseIfType.class, reader);
    }
