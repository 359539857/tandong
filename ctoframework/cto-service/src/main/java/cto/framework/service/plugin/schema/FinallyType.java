...
public class FinallyType implements java.io.Serializable {
     ...
     */
    private cto.framework.service.plugin.schema.FinallyTypeChoice _finallyTypeChoice;
     ...
     */
    public cto.framework.service.plugin.schema.FinallyTypeChoice getFinallyTypeChoice() {
     ...
     * 'finallyTypeChoice'.
     */
    public void setFinallyTypeChoice(final cto.framework.service.plugin.schema.FinallyTypeChoice finallyTypeChoice) {
     ...
     * cto.framework.service.plugin.schema.FinallyType
     */
    public static cto.framework.service.plugin.schema.FinallyType unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (cto.framework.service.plugin.schema.FinallyType) org.exolab.castor.xml.Unmarshaller.unmarshal(cto.framework.service.plugin.schema.FinallyType.class, reader);
    }
