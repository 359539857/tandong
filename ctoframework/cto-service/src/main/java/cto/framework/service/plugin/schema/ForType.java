...
public class ForType implements java.io.Serializable {
     ...
     */
    private cto.framework.service.plugin.schema.ForTypeChoice _forTypeChoice;
     ...
     */
    public cto.framework.service.plugin.schema.ForTypeChoice getForTypeChoice() {
     ...
     */
    public void setForTypeChoice(final cto.framework.service.plugin.schema.ForTypeChoice forTypeChoice) {
     ...
     * cto.framework.service.plugin.schema.ForType
     */
    public static cto.framework.service.plugin.schema.ForType unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (cto.framework.service.plugin.schema.ForType) org.exolab.castor.xml.Unmarshaller.unmarshal(cto.framework.service.plugin.schema.ForType.class, reader);
    }
