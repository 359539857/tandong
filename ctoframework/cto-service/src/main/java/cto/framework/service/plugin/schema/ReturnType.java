...
public class ReturnType implements java.io.Serializable {
     ...
     */
    private java.util.List<cto.framework.service.plugin.schema.ReturnItem> _returnItemList;
    ...
    public ReturnType() {
        ...
        setInfo("ok");
        setText("ok");
        this._returnItemList = new java.util.ArrayList<cto.framework.service.plugin.schema.ReturnItem>();
    }
     ...
     */
    public void addReturnItem(final cto.framework.service.plugin.schema.ReturnItem vReturnItem) throws java.lang.IndexOutOfBoundsException {
     ...
     * given is outside the bounds of the collection
     */
    public void addReturnItem(final int index,final cto.framework.service.plugin.schema.ReturnItem vReturnItem) throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<? extends cto.framework.service.plugin.schema.ReturnItem> enumerateReturnItem() {
     ...
     * cto.framework.service.plugin.schema.ReturnItem at the given
     * index
     */
    public cto.framework.service.plugin.schema.ReturnItem getReturnItem(final int index) throws java.lang.IndexOutOfBoundsException {
     ...
     */
    public cto.framework.service.plugin.schema.ReturnItem[] getReturnItem() {
        cto.framework.service.plugin.schema.ReturnItem[] array = new cto.framework.service.plugin.schema.ReturnItem[0];
     ...
     * collection
     */
    public java.util.Iterator<? extends cto.framework.service.plugin.schema.ReturnItem> iterateReturnItem() {
     ...
     */
    public boolean removeReturnItem(final cto.framework.service.plugin.schema.ReturnItem vReturnItem) {
     ...
     */
    public cto.framework.service.plugin.schema.ReturnItem removeReturnItemAt(final int index) {
        java.lang.Object obj = this._returnItemList.remove(index);
        return (cto.framework.service.plugin.schema.ReturnItem) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setReturnItem(final int index,final cto.framework.service.plugin.schema.ReturnItem vReturnItem) throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._returnItemList.size()) {
     ...
     */
    public void setReturnItem(final cto.framework.service.plugin.schema.ReturnItem[] vReturnItemArray) {
        //-- copy array
     ...
     * cto.framework.service.plugin.schema.ReturnType
     */
    public static cto.framework.service.plugin.schema.ReturnType unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
