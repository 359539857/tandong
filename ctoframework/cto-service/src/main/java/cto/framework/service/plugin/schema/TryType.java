...
public class TryType implements java.io.Serializable {
     ...
     */
    private cto.framework.service.plugin.schema.TryTypeChoice _tryTypeChoice;
     ...
     */
    public cto.framework.service.plugin.schema.TryTypeChoice getTryTypeChoice() {
     ...
     */
    public void setTryTypeChoice(final cto.framework.service.plugin.schema.TryTypeChoice tryTypeChoice) {
     ...
     * cto.framework.service.plugin.schema.TryType
     */
    public static cto.framework.service.plugin.schema.TryType unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (cto.framework.service.plugin.schema.TryType) org.exolab.castor.xml.Unmarshaller.unmarshal(cto.framework.service.plugin.schema.TryType.class, reader);
    }
