...
import cto.framework.service.plugin.schema.ForType;
...
public class ForTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ForTypeDescriptor() {
        ...
        //-- _forTypeChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(cto.framework.service.plugin.schema.ForTypeChoice.class, "_forTypeChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ForType target = (ForType) object;
                    target.setForTypeChoice( (cto.framework.service.plugin.schema.ForTypeChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new cto.framework.service.plugin.schema.ForTypeChoice();
            }
        };
        desc.setSchemaType("cto.framework.service.plugin.schema.ForTypeChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new cto.framework.service.plugin.schema.descriptors.ForTypeChoiceDescriptor());
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.service.plugin.schema.ForType.class;
    }
