...
/**
 * Class SQLElseTypeItemDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SQLElseTypeItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SQLElseTypeItemDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SQLElseTypeItem target = (SQLElseTypeItem) object;
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.service.plugin.schema.SQLElseTypeItem.class;
    }
