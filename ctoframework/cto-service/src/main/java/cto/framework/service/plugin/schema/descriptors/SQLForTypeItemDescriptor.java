...
/**
 * Class SQLForTypeItemDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SQLForTypeItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SQLForTypeItemDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SQLForTypeItem target = (SQLForTypeItem) object;
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.service.plugin.schema.SQLForTypeItem.class;
    }
