...
/**
 * Class SQLIfTypeItemDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SQLIfTypeItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SQLIfTypeItemDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SQLIfTypeItem target = (SQLIfTypeItem) object;
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.service.plugin.schema.SQLIfTypeItem.class;
    }
