...
/**
 * Class SelectTypeItemDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SelectTypeItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SelectTypeItemDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SelectTypeItem target = (SelectTypeItem) object;
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.service.plugin.schema.SelectTypeItem.class;
    }
