...
import cto.framework.service.plugin.schema.ValidatorType;
...
public class ValidatorTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ValidatorTypeDescriptor() {
        ...
        //-- _fieldList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(cto.framework.service.plugin.schema.Field.class, "_fieldList", "Field", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ValidatorType target = (ValidatorType) object;
                    target.addField( (cto.framework.service.plugin.schema.Field) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new cto.framework.service.plugin.schema.Field();
            }
        };
        desc.setSchemaType("list");
        desc.setComponentType("cto.framework.service.plugin.schema.Field");
        desc.setHandler(handler);
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.service.plugin.schema.ValidatorType.class;
    }
