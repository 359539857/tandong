...
public class HadoopServerType implements java.io.Serializable {
     ...
     * cto.framework.service.schema.HadoopServerType
     */
    public static cto.framework.service.schema.HadoopServerType unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (cto.framework.service.schema.HadoopServerType) org.exolab.castor.xml.Unmarshaller.unmarshal(cto.framework.service.schema.HadoopServerType.class, reader);
    }
