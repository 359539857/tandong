...
public class ElseType implements java.io.Serializable {
     ...
     */
    private cto.framework.web.action.plugin.schema.ElseTypeChoice _elseTypeChoice;
     ...
     */
    public cto.framework.web.action.plugin.schema.ElseTypeChoice getElseTypeChoice() {
     ...
     */
    public void setElseTypeChoice(final cto.framework.web.action.plugin.schema.ElseTypeChoice elseTypeChoice) {
     ...
     * cto.framework.web.action.plugin.schema.ElseType
     */
    public static cto.framework.web.action.plugin.schema.ElseType unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (cto.framework.web.action.plugin.schema.ElseType) org.exolab.castor.xml.Unmarshaller.unmarshal(cto.framework.web.action.plugin.schema.ElseType.class, reader);
    }
