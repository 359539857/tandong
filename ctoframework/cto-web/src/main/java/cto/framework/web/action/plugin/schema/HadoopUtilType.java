...
public class HadoopUtilType implements java.io.Serializable {
     ...
     * cto.framework.web.action.plugin.schema.HadoopUtilType
     */
    public static cto.framework.web.action.plugin.schema.HadoopUtilType unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (cto.framework.web.action.plugin.schema.HadoopUtilType) org.exolab.castor.xml.Unmarshaller.unmarshal(cto.framework.web.action.plugin.schema.HadoopUtilType.class, reader);
    }
