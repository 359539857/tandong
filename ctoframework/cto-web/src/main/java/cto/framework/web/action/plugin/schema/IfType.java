...
public class IfType implements java.io.Serializable {
     ...
     * Field _ifTypeChoice.
     */
    private cto.framework.web.action.plugin.schema.IfTypeChoice _ifTypeChoice;
     ...
     */
    public cto.framework.web.action.plugin.schema.IfTypeChoice getIfTypeChoice() {
     ...
     */
    public void setIfTypeChoice(final cto.framework.web.action.plugin.schema.IfTypeChoice ifTypeChoice) {
     ...
     * cto.framework.web.action.plugin.schema.IfType
     */
    public static cto.framework.web.action.plugin.schema.IfType unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (cto.framework.web.action.plugin.schema.IfType) org.exolab.castor.xml.Unmarshaller.unmarshal(cto.framework.web.action.plugin.schema.IfType.class, reader);
    }
