...
public class InvokeType implements java.io.Serializable {
     ...
     */
    private java.util.List<cto.framework.web.action.plugin.schema.MethodParameter> _methodParameterList;

    public InvokeType() {
        super();
        this._methodParameterList = new java.util.ArrayList<cto.framework.web.action.plugin.schema.MethodParameter>();
    }
     ...
     */
    public void addMethodParameter(final cto.framework.web.action.plugin.schema.MethodParameter vMethodParameter) throws java.lang.IndexOutOfBoundsException {
     ...
     * given is outside the bounds of the collection
     */
    public void addMethodParameter(final int index,final cto.framework.web.action.plugin.schema.MethodParameter vMethodParameter) throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<? extends cto.framework.web.action.plugin.schema.MethodParameter> enumerateMethodParameter() {
     ...
     * cto.framework.web.action.plugin.schema.MethodParameter at
     * the given index
     */
    public cto.framework.web.action.plugin.schema.MethodParameter getMethodParameter(final int index) throws java.lang.IndexOutOfBoundsException {
     ...
     */
    public cto.framework.web.action.plugin.schema.MethodParameter[] getMethodParameter() {
        cto.framework.web.action.plugin.schema.MethodParameter[] array = new cto.framework.web.action.plugin.schema.MethodParameter[0];
     ...
     * collection
     */
    public java.util.Iterator<? extends cto.framework.web.action.plugin.schema.MethodParameter> iterateMethodParameter() {
     ...
     */
    public boolean removeMethodParameter(final cto.framework.web.action.plugin.schema.MethodParameter vMethodParameter) {
     ...
     */
    public cto.framework.web.action.plugin.schema.MethodParameter removeMethodParameterAt(final int index) {
        java.lang.Object obj = this._methodParameterList.remove(index);
        return (cto.framework.web.action.plugin.schema.MethodParameter) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setMethodParameter(final int index,final cto.framework.web.action.plugin.schema.MethodParameter vMethodParameter) throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._methodParameterList.size()) {
     ...
     */
    public void setMethodParameter(final cto.framework.web.action.plugin.schema.MethodParameter[] vMethodParameterArray) {
        //-- copy array
     ...
     * cto.framework.web.action.plugin.schema.InvokeType
     */
    public static cto.framework.web.action.plugin.schema.InvokeType unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (cto.framework.web.action.plugin.schema.InvokeType) org.exolab.castor.xml.Unmarshaller.unmarshal(cto.framework.web.action.plugin.schema.InvokeType.class, reader);
    }
