...
public class OutResponseType implements java.io.Serializable {
     ...
     * Field _headerList.
     */
    private java.util.List<cto.framework.web.action.plugin.schema.Header> _headerList;

    public OutResponseType() {
        super();
        this._headerList = new java.util.ArrayList<cto.framework.web.action.plugin.schema.Header>();
    }
     ...
     */
    public void addHeader(final cto.framework.web.action.plugin.schema.Header vHeader) throws java.lang.IndexOutOfBoundsException {
     ...
     * given is outside the bounds of the collection
     */
    public void addHeader(final int index,final cto.framework.web.action.plugin.schema.Header vHeader) throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<? extends cto.framework.web.action.plugin.schema.Header> enumerateHeader() {
     ...
     * cto.framework.web.action.plugin.schema.Header at the given
     * index
     */
    public cto.framework.web.action.plugin.schema.Header getHeader(final int index) throws java.lang.IndexOutOfBoundsException {
     ...
     */
    public cto.framework.web.action.plugin.schema.Header[] getHeader() {
        cto.framework.web.action.plugin.schema.Header[] array = new cto.framework.web.action.plugin.schema.Header[0];
     ...
     * collection
     */
    public java.util.Iterator<? extends cto.framework.web.action.plugin.schema.Header> iterateHeader() {
     ...
     */
    public boolean removeHeader(final cto.framework.web.action.plugin.schema.Header vHeader) {
     ...
     */
    public cto.framework.web.action.plugin.schema.Header removeHeaderAt(final int index) {
        java.lang.Object obj = this._headerList.remove(index);
        return (cto.framework.web.action.plugin.schema.Header) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setHeader(final int index,final cto.framework.web.action.plugin.schema.Header vHeader) throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._headerList.size()) {
     ...
     * @param vHeaderArray
     */
    public void setHeader(final cto.framework.web.action.plugin.schema.Header[] vHeaderArray) {
        //-- copy array
        _headerList.clear();
     ...
     * cto.framework.web.action.plugin.schema.OutResponseType
     */
    public static cto.framework.web.action.plugin.schema.OutResponseType unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (cto.framework.web.action.plugin.schema.OutResponseType) org.exolab.castor.xml.Unmarshaller.unmarshal(cto.framework.web.action.plugin.schema.OutResponseType.class, reader);
    }
