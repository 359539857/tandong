...
/**
 * Class CatchTypeChoiceItemDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class CatchTypeChoiceItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CatchTypeChoiceItemDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CatchTypeChoiceItem target = (CatchTypeChoiceItem) object;
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.web.action.plugin.schema.CatchTypeChoiceItem.class;
    }
