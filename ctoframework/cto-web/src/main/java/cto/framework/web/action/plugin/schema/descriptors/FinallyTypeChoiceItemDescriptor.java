...
/**
 * Class FinallyTypeChoiceItemDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class FinallyTypeChoiceItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FinallyTypeChoiceItemDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                FinallyTypeChoiceItem target = (FinallyTypeChoiceItem) object;
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.web.action.plugin.schema.FinallyTypeChoiceItem.class;
    }
