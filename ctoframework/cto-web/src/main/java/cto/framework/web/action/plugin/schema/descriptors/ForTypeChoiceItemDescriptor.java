...
/**
 * Class ForTypeChoiceItemDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ForTypeChoiceItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ForTypeChoiceItemDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ForTypeChoiceItem target = (ForTypeChoiceItem) object;
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.web.action.plugin.schema.ForTypeChoiceItem.class;
    }
