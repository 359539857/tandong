...
/**
 * Class IfTypeChoiceItemDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class IfTypeChoiceItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public IfTypeChoiceItemDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                IfTypeChoiceItem target = (IfTypeChoiceItem) object;
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.web.action.plugin.schema.IfTypeChoiceItem.class;
    }
