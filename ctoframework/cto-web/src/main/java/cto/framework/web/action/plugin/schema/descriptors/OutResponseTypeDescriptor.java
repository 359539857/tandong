...
import cto.framework.web.action.plugin.schema.OutResponseType;
...
public class OutResponseTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OutResponseTypeDescriptor() {
        ...
        //-- _headerList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(cto.framework.web.action.plugin.schema.Header.class, "_headerList", "Header", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    OutResponseType target = (OutResponseType) object;
                    target.addHeader( (cto.framework.web.action.plugin.schema.Header) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new cto.framework.web.action.plugin.schema.Header();
            }
        };
        desc.setSchemaType("list");
        desc.setComponentType("cto.framework.web.action.plugin.schema.Header");
        desc.setHandler(handler);
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.web.action.plugin.schema.OutResponseType.class;
    }
