...
/**
 * Class TransTypeChoiceItemDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class TransTypeChoiceItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TransTypeChoiceItemDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                TransTypeChoiceItem target = (TransTypeChoiceItem) object;
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.web.action.plugin.schema.TransTypeChoiceItem.class;
    }
