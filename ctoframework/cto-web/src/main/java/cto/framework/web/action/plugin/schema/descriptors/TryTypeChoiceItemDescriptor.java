...
/**
 * Class TryTypeChoiceItemDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class TryTypeChoiceItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TryTypeChoiceItemDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                TryTypeChoiceItem target = (TryTypeChoiceItem) object;
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.web.action.plugin.schema.TryTypeChoiceItem.class;
    }
