...
import cto.framework.web.action.schema.ImportResourceType;

/**
 * Class ImportResourceTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ImportResourceTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ImportResourceTypeDescriptor() {
        super();
        _nsURI = "http://www.w3school.com.cn";
        _xmlName = "ImportResourceType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ImportResourceType target = (ImportResourceType) object;
    ...
    public java.lang.Class getJavaClass() {
        return cto.framework.web.action.schema.ImportResourceType.class;
    }
